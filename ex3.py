...
# usual order of operations so it actally reads 25 + (30/6)=30
print("Hens", 25 + 30 / 6)
...
# will this change when adding paranthesis
# don't know where to start adding? or if it will even run with the extra parenthesis
